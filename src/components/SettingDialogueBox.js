    ...
    <>
      <Transition appear show={open} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={handleClose}>
          <div className="fixed inset-0 overflow-y-auto bg-[#000000aa]">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-xl bg-gray-700 p-12 text-center align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h5"
                          ...
                          <div className="flex flex-col">
                            <div className="flex flex-col w-full">
                              ...
                              <div className="p-4 relative mt-0 md:mt-10 ">
                                <div className="flex flex-1 relative w-1/2 md:w-full h-1/2 md:h-auto overflow-hidden rounded">
                            ...
                            <div className="relative mt-10">
                              <div className="flex relative w-full h-[320px]">
                                <video
                                  ...
                                  controls={false}
                                  className={
                                    "rounded-md h-full bg-gray-150 w-full object-cover flip"
                                  }
                                />
                              </div>
                            </div>
